...
/**
 * Dialog cho import danh sách điểm cộng từ file Excel
 */
public class ImportDCExcelDialog extends JDialog {
    private File selectedFile;
    private boolean confirmed = false;
    private final JLabel fileLabel = new JLabel("Chưa chọn file");
    private final JProgressBar progressBar = new JProgressBar();

    public ImportDCExcelDialog(Frame owner) {
        super(owner, "Import Điểm Cộng Thí Sinh", true);
        setSize(500, 250);
        ...
        // Info panel đã được cập nhật lại tên các cột giống với bảng trong DiemCongPanel
        JLabel infoLabel = new JLabel("<html><b>Import danh sách điểm cộng từ file Excel</b><br/>" +
                "Định dạng: .xlsx hoặc .xls<br/>" +
                "Cột dữ liệu: ID, CCCD, Mã Ngành, Mã Tổ Hợp, Phương thức, Điểm CC, Điểm UTXT, Điểm Tổng, Ghi chú, Keys</html>");
