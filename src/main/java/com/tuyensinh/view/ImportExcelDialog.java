...
public class ImportExcelDialog extends JDialog {
    ...
    public ImportExcelDialog(Frame owner) {
        super(owner, "Import Danh Sách Thí Sinh", true);
        setSize(500, 250);
        ...
        // Info panel
        JLabel infoLabel = new JLabel("<html><b>Import danh sách thí sinh từ file Excel</b><br/>" +
                "Định dạng: .xlsx hoặc .xls<br/>" +
                "Cột dữ liệu: CCCD, Số báo danh, Họ, Tên, Ngày sinh, Giới tính, Email, Điện thoại, " +
                "Nơi sinh, Đối tượng, Khu vực</html>");
